  ...
  return ( 
    <div className='relative h-lvh w-full'>
     ...
     <div className='flex flex-col items-center justify-center gap-4'>
      ...
      <div className='text-2xl font-semibold'>Please select your role</div>
     </div>

     <div className='grid grid-cols-3 gap-16'>

         <Link to={"/SignUpForm"}>
      <div className='flex flex-col gap-5 items-center border-2 py-8 px-12 rounded-2xl bg-white border-purple-500 cursor-pointer '>
       ...
       <Link to={"/SignUpForm"}>
      <div className='flex flex-col gap-5 items-center border-2 py-8 px-10 rounded-2xl bg-white border-purple-500 cursor-pointer'>
